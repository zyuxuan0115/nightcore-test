...
clang++ -I$NIGHTCORE_TEST_PATH/socialNetwork/src -fPIC -emit-llvm -gmodules -S $NIGHTCORE_TEST_PATH/socialNetwork/src/ComposePostService/ComposePostService.cpp -c -o ComposePost.ll
