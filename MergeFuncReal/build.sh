...
opt -load $LLVM_PATH/build/lib/LLVMMergeFuncReal.so -enable-new-pm=0 -ChangeFuncName bar.ll -S -o bar_only.ll
...
opt -load $LLVM_PATH/build/lib/LLVMMergeFuncReal.so -S -enable-new-pm=0 -o foo_bar.ll -MergeFunc < foo_rpc_bar.ll
